...
#include "smopos_const.h"       // Include header for the SMOPOS_CONST object
...
#include "speed_pr.h"           // Include header for the SPEED_MEAS_QEP object
...
typedef struct {
	...
	_iq  offset_shntA,   // shunt current feedback A - offset @ 0A
		 ...
		 offset_shntDC,   // shunt current feedback C - offset @ 0A
...
//	PID_CONTROLLER	pid_spd;
	...
	SMOPOS_CONST smo_const;    // Instance a sliding-mode position observer constant Module

	SMOPOS smo;                // Instance a position estimator

	SPEED_ESTIMATION speed1;   // Instance a speed calculator based on sliding-mode position observer
...
#define DRV830x_MOTOR_DEFAULTS  {                         \
		    ...
		    0,          /*  offsetB               */      \
                                                          \
			0,0,0,0,    /*  currents A, B, C, DC  */      \
			0,0,0,0,    /*  voltages A, B, C, DC  */      \
			0,0,0,0,    /*  Temp A, B, C, motor  */       \
                                                          \
			0,			/*  alignCntr			  */      \
            20000,		/*  alignCnt 			  */      \
			                                              \
...
/*{PID_TERM_DEFAULTS, PID_PARAM_DEFAULTS, PID_DATA_DEFAULTS},    pid_spd  */   \
		    ...
		    SMOPOS_CONST_DEFAULTS,    /* smo_const*/      \
		    SMOPOS_DEFAULTS,          /* smo      */      \
		    SPEED_ESTIMATION_DEFAULTS,/* speed1   */      \
